...
const a_trades_date = _atom(defaultDate());
const a_trades_fname = _atom(null);
export const a_trades_input = atom(
    get => ({ date: get(a_trades_date), fname: get(a_trades_fname) }),
    (get, set, { date, fname }) => {
        set(a_trades_date, date);
        set(a_trades_fname, fname);
    }
);
...
export const a_input = atom(
    get => {
        ...
        const targetsInput = get(a_trades_input);
...
const a_trades_selected_cell = _fatom(firstCell);
...
export const a_selected_cell = atom(
    get => {
        ...
        switch (tab) {
            case TRADE: return get(a_trades_selected_cell);
    ...
    (get, set, cell) => {
        ...
        switch (tab) {
            case TRADE: return set(a_trades_selected_cell, cell);
...
const a_trades_nodes = _fatom(null);
const a_compare_nodes = _fatom(null);
const a_benchmarks_nodes = _fatom(null);

export const a_trades_meta = _fatom(null);
...
export const a_has_targets = atom(get => !_.isEmpty(get(a_trades_nodes)));
...
export const a_selected_family = atom(
    get => {
        ...
        const { fname } = get(a_trades_input);
